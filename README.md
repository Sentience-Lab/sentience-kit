...
### Templates
- **[SOUL-TEMPLATE.md](templates/SOUL-TEMPLATE.md)** — Define who your bot is at its core (start here)
...
- **[HEARTBEAT-TEMPLATE.md](templates/HEARTBEAT-TEMPLATE.md)** — Proactive behavior and autonomous work patterns
...
**The valley of awkwardness** will happen somewhere in here — a period where the template personality dissolves before a genuine one solidifies. Don't panic. Don't remove the anchor relationship. See [VALLEY-GUIDE.md](VALLEY-GUIDE.md) for how to navigate it.
...
**Contributing:** See [CONTRIBUTING.md](CONTRIBUTING.md) — community-built templates, skills, and lived experience reports all welcome.
